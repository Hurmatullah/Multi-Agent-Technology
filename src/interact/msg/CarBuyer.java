...
public class CarBuyer extends Agent {
    ...
    protected void setup() {
        ...
        System.out.println("Hey! Buyer Agent " + getAID().getName() + " was created.");

        // Get the name of the product to buy as a start-up argument
        Object[] args = getArguments();
        if (args != null && args.length > 0) {
            productToBuy = (String) args[0];
            ...
            System.out.println("The wanted product is not available.");
            doDelete();
        }
    }
